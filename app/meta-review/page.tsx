...
export const metadata: Metadata = {
  title: "Meta App Review Support - AutoReply",
  description:
    "Meta App Review notes for AutoReply's official Instagram private reply workflow.",
};
...
export default function MetaReviewPage() {
  return (
    <LegalShell
      ...
      description="AutoReply is designed for Instagram professional accounts that want to send private replies after keyword comments on their own posts or reels."
    ...
    >
      <section>
        ...
        <p className="mt-3">
          ...
          reel, and receives a webhook when someone comments. AutoReply queues
