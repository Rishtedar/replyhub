...
export const manychatAlternativePage: SeoPageConfig = {
  ...
  description:
    "AutoReply is for teams that do not need a broad chatbot builder. It turns keyword comments into Meta-compliant private replies, tracked links, campaign analytics, and client reports.",
  ...
  sections: [
    {
      ...
      body: "Broad automation suites can be powerful, but they also add flow-builder weight. AutoReply keeps the campaign path tight: keyword, post, reply, link, result.",
    },
    {
      title: "Agency proof",
  ...
  comparisonTitle: "AutoReply vs broad chatbot builders",
  comparisons: [
    {
      label: "Setup",
  ...
  faqs: [
    {
      title: "Is AutoReply a full Manychat replacement?",
      body: "No. AutoReply is intentionally focused on Instagram comment-to-DM campaigns. If you need a complete chatbot suite, use a broad platform. If you need fast campaign loops, AutoReply is built for that.",
    },
    {
...
export const agenciesSeoPage: SeoPageConfig = {
  ...
  description:
    "AutoReply gives agencies multi-account workspaces, client-ready reports, tracked links, and a focused comment-to-DM workflow for repeatable Instagram campaigns.",
...
export const commentLinkSeoPage: SeoPageConfig = {
  ...
  faqs: [
    ...
    {
      title: "Does AutoReply send a normal Instagram DM?",
